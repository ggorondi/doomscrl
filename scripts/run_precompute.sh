...
echo "  rsync -avz artifacts/features/ local:doomscrl/artifacts/features/"
echo "  rsync -avz models/tribev2/fmri_encoder.pt local:doomscrl/models/tribev2/"
echo "  rsync -avz artifacts/video_catalog.json local:doomscrl/artifacts/"
